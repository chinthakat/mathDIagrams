...
export default function Sidebar({ mode, setMode, addShape, addClipart, handleExport, handleSaveToLibrary, recentlyUsed = [], openAIGenerator }) {
  ...
  const allowedCategories2D = ['Basic Shapes', 'Geometry', 'Triangles', 'Arrows', 'Diagram Annotations', 'Math Engines', 'Logic & Problem Solving', 'Text & Annotation', 'Images & Icons', 'Measurement', 'Coordinate Geometry', '3D & Diagram', 'Place Value & Counting', 'Science & Lab', 'Buildings', 'Roads & Paths', 'Nature & Water'];
